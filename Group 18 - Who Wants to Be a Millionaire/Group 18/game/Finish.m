...
% Last Modified by GUIDE v2.5 14-Jan-2016 22:42:28
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
run playgame.m % This tells Matlab to run the playgame.m file, in order to push play the game again, when the button is clicked.
