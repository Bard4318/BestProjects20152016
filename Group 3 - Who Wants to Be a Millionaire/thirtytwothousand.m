...
chosenquestion32000 = handles.chosenquestion32000
% This brings up the randomly generated questions from the SetQuestions.m
% script, as well as the corresponding answers.
temp_quest = chosenquestion32000{1,1}
temp_A = chosenquestion32000{1,2}
temp_B = chosenquestion32000{1,3}
temp_C = chosenquestion32000{1,4}
temp_D = chosenquestion32000{1,5}
temp_Answer = chosenquestion32000{1,6};
question = 10
...
pause(0.3)
set(handles.question_field,'String','One more question to go until your next milestone. Take your time')
...
% the colours change.
set(handles.q16000,'BackgroundColor',[0 0.7 0])  % Sets the background colour of the static textbox representing the money stage £16,000 to green, since the contestant has made it to the £32,000 question by answering the £16,000 correctly.
set(handles.q32000,'BackgroundColor',[0.87058 0.5 0]) % Sets the background colour of the static textbox representing the money stage £32,000 to orange, as this represents that the contestant is currently on this money stage question.
