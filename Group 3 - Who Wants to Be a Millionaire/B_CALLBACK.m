...
% This code is for when Answer B has been selected
...
set(handles.B,'BackgroundColor',[0.87058 0.5 0])
...
if temp_Answer=='1'
    ...
    % If the value of temp_Answer = 2 (the correct answer), flash 'B' as green and orange    
if temp_Answer == '2'
    pause(2)
    for i = 1:3
        set(handles.B,'BackgroundColor',[0 0.7 0]) %GREEN%
        pause(0.2)
        set(handles.B,'BackgroundColor',[0.87058 0.5 0]) %ORANGE%
        pause(0.2)
    end
    set(handles.B,'BackgroundColor',[0 0.7 0]) %GREEN%
    % Add 1 to the value of the rightanswer variable
...
% If the value of temp_Answer = 4 (D), highlight 'D' as green
if temp_Answer == '4'
    pause(2)
    for i = 1:3
        set(handles.D,'BackgroundColor',[0 0.7 0]) %GREEN%
        pause(0.2)
        set(handles.D,'BackgroundColor',[0.16862 0.38039 0.82352]) %BLUE%
        pause(0.2)
    end
    set(handles.D,'BackgroundColor',[0 0.7 0])
end
pause(0.2)
