...
chosenquestion16000 = handles.chosenquestion16000
% This brings up the randomly generated questions from the SetQuestions.m
% script, as well as the corresponding answers.
temp_quest = chosenquestion16000{1,1}
temp_A = chosenquestion16000{1,2}
temp_B = chosenquestion16000{1,3}
temp_C = chosenquestion16000{1,4}
temp_D = chosenquestion16000{1,5}
temp_Answer = chosenquestion16000{1,6};
question = 9
...
pause(0.3)
set(handles.question_field,'String','Amazing work! This next question is worth £16,000')
...
% the colours change.
set(handles.q8000,'BackgroundColor',[0 0.7 0])  % Sets the background colour of the static textbox representing the money stage £8,000 to green, since the contestant has made it to the £16,000 question by answering the £8,000 correctly.
set(handles.q16000,'BackgroundColor',[0.87058 0.5 0]) % Sets the background colour of the static textbox representing the money stage £16,000 to orange, as this represents that the contestant is currently on this money stage question.
