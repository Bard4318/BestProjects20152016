...
chosenquestion4000 = handles.chosenquestion4000
% This brings up the randomly generated questions from the SetQuestions.m
% script, as well as the corresponding answers.
temp_quest = chosenquestion4000{1,1}
temp_A = chosenquestion4000{1,2}
temp_B = chosenquestion4000{1,3}
temp_C = chosenquestion4000{1,4}
temp_D = chosenquestion4000{1,5}
temp_Answer = chosenquestion4000{1,6};
question = 7
...
pause(0.3)
set(handles.question_field,'String','This next question is worth £4000. Remember, you can still walk away with £2000')
...
% the colours change.
set(handles.q2000,'BackgroundColor',[0 0.7 0])  % Sets the background colour of the static textbox representing the money stage £2,000 to green, since the contestant has made it to the £4,000 question by answering the £2,000 correctly.
set(handles.q4000,'BackgroundColor',[0.87058 0.5 0]) % Sets the background colour of the static textbox representing the money stage £4,000 to orange, as this represents that the contestant is currently on this money stage question.
