...
chosenquestion1000000 = handles.chosenquestion1000000
% This brings up the randomly generated questions from the SetQuestions.m
% script, as well as the corresponding answers.
temp_quest = chosenquestion1000000{1,1}
temp_A = chosenquestion1000000{1,2}
temp_B = chosenquestion1000000{1,3}
temp_C = chosenquestion1000000{1,4}
temp_D = chosenquestion1000000{1,5}
temp_Answer = chosenquestion1000000{1,6};
question = 15
...
pause(0.3)
set(handles.question_field,'String','This is the last question. Get this right, and you will be a millionaire. Please take your time')
...
% the colours change.
set(handles.q500000,'BackgroundColor',[0 0.7 0])  % Sets the background colour of the static textbox representing the money stage £500,000 to green, since the contestant has made it to the £1 Million question by answering the £500,000 correctly.
set(handles.q1million,'BackgroundColor',[0.87058 0.5 0]) % Sets the background colour of the static textbox representing the money stage £1 Million to orange, as this represents that the contestant is currently on this money stage question.
