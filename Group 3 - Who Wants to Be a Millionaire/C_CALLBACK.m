...
% This code is for when Answer C has been selected
...
set(handles.C,'BackgroundColor',[0.87058 0.5 0]) %ORANGE%
...
% If the value of temp_Answer = 3 (the correct answer), flash 'C' as green and orange
if temp_Answer == '3'
    pause(2)
    for i = 1:3
