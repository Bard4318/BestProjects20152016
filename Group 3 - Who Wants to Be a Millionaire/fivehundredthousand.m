...
chosenquestion500000 = handles.chosenquestion500000
% This brings up the randomly generated questions from the SetQuestions.m
% script, as well as the corresponding answers.
temp_quest = chosenquestion500000{1,1}
temp_A = chosenquestion500000{1,2}
temp_B = chosenquestion500000{1,3}
temp_C = chosenquestion500000{1,4}
temp_D = chosenquestion500000{1,5}
temp_Answer = chosenquestion500000{1,6};
question = 14
...
pause(0.3)
set(handles.question_field,'String','You now have £250,000. Thats an awful lot of money. This is the next question worth half a million.')
...
% the colours change.
set(handles.q250000,'BackgroundColor',[0 0.7 0])  % Sets the background colour of the static textbox representing the money stage £250,000 to green, since the contestant has made it to the £500,000 question by answering the £250,000 correctly.
set(handles.q500000,'BackgroundColor',[0.87058 0.5 0]) % Sets the background colour of the static textbox representing the money stage £500,000 to orange, as this represents that the contestant is currently on this money stage question.
