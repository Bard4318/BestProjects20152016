...
chosenquestion2000 = handles.chosenquestion2000
% This brings up the randomly generated questions from the SetQuestions.m
% script, as well as the corresponding answers.
temp_quest = chosenquestion2000{1,1}
temp_A = chosenquestion2000{1,2}
temp_B = chosenquestion2000{1,3}
temp_C = chosenquestion2000{1,4}
temp_D = chosenquestion2000{1,5}
temp_Answer = chosenquestion2000{1,6};
question = 6
...
pause(0.3)
set(handles.question_field,'String','You have now reached your first checkpoint. This next question is worth £2000, take a look')
...
% the colours change.
set(handles.q1000,'BackgroundColor',[0 0.7 0])  % Sets the background colour of the static textbox representing the money stage £1,000 to green, since the contestant has made it to the £2,000 question by answering the £1,000 correctly.
set(handles.q2000,'BackgroundColor',[0.87058 0.5 0]) % Sets the background colour of the static textbox representing the money stage £2,000 to orange, as this represents that the contestant is currently on this money stage question.
