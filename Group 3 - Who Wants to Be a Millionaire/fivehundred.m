...
chosenquestion500 = handles.chosenquestion500
% This brings up the randomly generated questions from the SetQuestions.m
% script, as well as the corresponding answers.
temp_quest = chosenquestion500{1,1}
temp_A = chosenquestion500{1,2}
temp_B = chosenquestion500{1,3}
temp_C = chosenquestion500{1,4}
temp_D = chosenquestion500{1,5}
temp_Answer = chosenquestion500{1,6};
question = 4
...
pause(0.3)
set(handles.question_field,'String','Another right answer! This one is for £500.')
...
% the colours change.
set(handles.q300,'BackgroundColor',[0 0.7 0])  % Sets the background colour of the static textbox representing the money stage £300 to green, since the contestant has made it to the £500 question by answering the £300 correctly.
set(handles.q500,'BackgroundColor',[0.87058 0.5 0]) % Sets the background colour of the static textbox representing the money stage £500 to orange, as this represents that the contestant is currently on this money stage question.
