...
chosenquestion64000 = handles.chosenquestion64000
% This brings up the randomly generated questions from the SetQuestions.m
% script, as well as the corresponding answers.
temp_quest = chosenquestion64000{1,1}
temp_A = chosenquestion64000{1,2}
temp_B = chosenquestion64000{1,3}
temp_C = chosenquestion64000{1,4}
temp_D = chosenquestion64000{1,5}
temp_Answer = chosenquestion64000{1,6};
question = 11
...
pause(0.3)
set(handles.question_field,'String','Now remember, even if you dont know this next one, you cant lose anything, so give it a go!')
...
% the colours change.
set(handles.q32000,'BackgroundColor',[0 0.7 0])  % Sets the background colour of the static textbox representing the money stage £32,000 to green, since the contestant has made it to the £64,000 question by answering the £32,000 correctly.
set(handles.q64000,'BackgroundColor',[0.87058 0.5 0]) % Sets the background colour of the static textbox representing the money stage £64,000 to orange, as this represents that the contestant is currently on this money stage question.
