...
% This code is for when Answer A has been selected
...
set(handles.A,'BackgroundColor',[0.87058 0.5 0]); %ORANGE%
% If the value of temp_Answer = 1 (the correct answer), flash 'A' as green and orange
if temp_Answer=='1';
    pause(1)
    for i = 1:3
